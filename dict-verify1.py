...
passwd_dict3 = dict(sorted(test_passwd_dict.items(), key=lambda item: item[1]))

if keyName in passwd_dict3:
    print(keyName,passwd_dict3[keyName])
else:
    passwd_dict3[keyName] = 1122
    print(passwd_dict3)
